...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "name": "HelloWorld",
        "sources": [
            "C:\\Users\\peter\\Documents\\GithubRepos\\pbrt-v3\\python\\HelloWorld.pyx"
        ]
    },
...
__PYX_EXTERN_C void printHelloWorld(void); /*proto*/
...
/* "HelloWorld.pyx":1
 * cdef public void printHelloWorld():             # <<<<<<<<<<<<<<
 *     print('Hello world')
 */
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("HelloWorld.printHelloWorld", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
